      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 mb-20 text-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-display font-medium text-[#111] tracking-tight mb-6">
            We are <span className="text-[#2FA84F]">Matrix Mobiles</span>.
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[500px]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="h-48 bg-[#111] rounded-[2rem] p-8 flex flex-col justify-center relative overflow-hidden group">
              <div className="absolute -right-10 -bottom-10 w-32 h-32 bg-[#2FA84F] rounded-full blur-[40px] opacity-20"></div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium mt-4 max-w-lg mx-auto">
              Why thousands of customers choose Matrix Mobiles as their trusted
              tech provider.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              >
                <div className="bg-white w-14 h-14 rounded-full flex items-center justify-center text-[#2FA84F] shadow-sm mb-6">
                  {value.icon}
                </div>
