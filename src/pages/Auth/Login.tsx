  ...
  return (
    <div className="flex-1 bg-[var(--bg-color)] flex flex-col justify-center items-center py-20 px-4 min-h-[calc(100vh-80px)]">
      <div className="w-full max-w-md relative">
        <div className="absolute -inset-4 bg-gradient-to-tr from-[#2FA84F]/20 to-transparent blur-2xl rounded-full opacity-50 pointer-events-none"></div>
        <div className="glass-panel rounded-[2rem] p-10 md:p-12 relative z-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-white/60 bg-white/40">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full bg-[#111] hover:bg-[#2FA84F] text-white py-4 rounded-full font-semibold transition-all shadow-md transform hover:-translate-y-1"
                disabled={loading}
              >
