...
export default function TradeIn() {
  return (
    <div className="flex-1 bg-[var(--bg-color)] min-h-screen">
      ...
      {/* How it works */}
      <section className="max-w-[1200px] mx-auto px-4 md:px-8 py-24">
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-[1.75rem] font-display font-medium text-[#111]">
            How it works?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div
              key={idx}
              className="bg-white p-10 flex flex-col items-center text-center rounded-xl shadow-sm border border-black/5 relative overflow-hidden group"
            >
      ...
      <section className="bg-gray-50 py-24 border-y border-black/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
            <h2 className="text-xl md:text-2xl font-display font-semibold text-[#111]">
