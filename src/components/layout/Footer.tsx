...
export function Footer() {
  return (
    <footer className="border-t border-[#0D162B]/10 bg-[#0A0D14] pt-10 md:pt-20 pb-6 md:pb-10 mt-auto text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16 text-center md:text-left">
          <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4 md:mb-6">
              <img
                src={encodeURI("/logo Trust mobile-dark-bg-v2.png")}
                alt="Trust Mobile"
            ...
            <div className="flex justify-center md:justify-start gap-3 md:gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#2E75B6] hover:text-white transition-colors duration-300"
              >
